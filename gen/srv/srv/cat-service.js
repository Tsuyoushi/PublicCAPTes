...
module.exports = cds.service.impl(async (service) => {
    ...
    service.before("NEW", 'Books', async (context) => {
        ...
        context.data.repositoryId = "175339f2-30d6-4520-a365-390e89ce4faf";
        ...
        context.data.folderId = await _createFolder(sdmCredentials.endpoints.ecmservice.url, connJwtToken, context.data.repositoryId, "243e717000e269414062c816", context.data.ID);
    });
});